...
public abstract class AbstractMessageConverterMethodProcessor extends AbstractMessageConverterMethodArgumentResolver
    ...
    private static final Set<String> WHITELISTED_EXTENSIONS = new HashSet<>(Arrays.asList("txt", "text", "yml",
     ...
     * whitelisted} or explicitly {@link ContentNegotiationManager#getAllFileExtensions() registered}. If not, and the
     * status is in the 2xx range, a 'Content-Disposition' header with a safe attachment file name ("f.txt") is added to
     * prevent RFD exploits.
     */
