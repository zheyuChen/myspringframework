...
public abstract class AbstractMessageConverterMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    /**
     * Return the configured {@link RequestBodyAdvice} and {@link RequestBodyAdvice} where each instance may be wrapped
     * as a {@link org.springframework.web.method.ControllerAdviceBean ControllerAdviceBean}.
     */
     ...
     * 
     * @param <T>
     *            the expected type of the argument value to be created
     * @param webRequest
     *            the current request
     * @param parameter
     *            the method parameter descriptor (may be {@code null})
     * @param paramType
